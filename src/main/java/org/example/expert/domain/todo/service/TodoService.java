...
public class TodoService {
    ...
    public Page<TodoSearchResponse> findTodo(
        String title, String managerName, LocalDate startDate, LocalDate endDate, int page, int size) {

        Pageable pageable = PageRequest.of(page - 1, size, Direction.DESC, "modifiedAt");
        return todoRepository.findTodos(new TodoSearchRequest(title, managerName, startDate, endDate), pageable);
    }
}
